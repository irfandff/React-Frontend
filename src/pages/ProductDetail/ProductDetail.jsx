   ...
   <>
    ...
    <div className='flex gap-[30px] px-24'>
            <div className=''>
                ...
                <img src={product.imageUrl ?? (product.name ?? 'No Name')} alt={product.name ?? 'No Name'} className='block w-[600px] h-[600px] object-cover'/>
            </div>
            <div className='flex flex-col gap-[20px]'>
              ...
              {product.stock > 0 ? (
                <div>
                  <Button
                    type="button"
                    className="inline-flex items-center justify-center gap-2 p-4 bg-[#003B46] text-center hover:bg-[#C4DAD2] text-white active:bg-[#4956ab]"
                  >
